...
const Advertise = () => {
    return (
        <div className='flex flex-col md:flex-row p-3 border border-teal-600  justify-center items-center
    rounded-tl-3xl rounded-br-3xl text-center'>
            ...
            <div className='flex-1 justify-center flex flex-col p-3 w-full'>
                ...
                <Button className='bg-blue-500 text-md mt-2 h-min'>
                    <Link className='text-wrap'
                        to={"https://google.com"} target="_blank" rel="noopener noreferrer">
            ...
            <div className='p-7 w-full md:w-2/5'><img
